...
const GOLD_LIGHT = { r: 255, g: 216, b: 112 };
const GOLD_DEEP  = { r: 168, g: 128, b: 38  };
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      for (const h of hexParticles) {
        ...
        const color = Math.random() > 0.6 ? rgb(GOLD_LIGHT) : rgb(GOLD);
      ...
      for (const beam of beams) {
        ...
        const lineColor = isGold ? GOLD : GOLD_LIGHT;
      ...
      for (const node of nodes) {
        ...
        const color = node.tier === 0 ? GOLD : node.tier === 1 ? GOLD_LIGHT : GOLD_DEEP;
